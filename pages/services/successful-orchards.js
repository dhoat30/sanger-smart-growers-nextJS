...
import SuccessfulOrchards from '../../Components/Pages/ServicePage/SuccessfulOrchards/SuccessfulOrchards'
...
export async function getStaticProps(context) {
    ...
    const pageData = await getSinglePage('successful-orchards')
